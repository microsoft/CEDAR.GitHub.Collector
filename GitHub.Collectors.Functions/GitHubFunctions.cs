...
namespace Microsoft.CloudMine.GitHub.Collectors.Functions
{
    public class GitHubFunctions
    {
        ...
        public GitHubFunctions(TelemetryConfiguration telemetryConfiguration, IHttpClient httpClient, IAdlsClient adlsClient, GitHubConfigManager configManager, IAuditLogger ifxLogger)
        {
