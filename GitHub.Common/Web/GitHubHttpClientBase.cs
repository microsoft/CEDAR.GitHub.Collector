...
namespace Microsoft.CloudMine.GitHub.Web
{
    ...
    public class GitHubHttpClientBase : IWebRequestStatsTracker
    {
        ...
        public GitHubHttpClientBase(IHttpClient httpClient, IRateLimiter rateLimiter, ITelemetryClient telemetryClient)
        {
